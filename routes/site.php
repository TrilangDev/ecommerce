...
$app->post("/register", function() {
    ...
    {
        User::setErrorRegister("Esse endereço de e-mail já está sendo usado por outro usuário.");
        header("Location: /login");
        exit;
    }
...
$app->post("/profile/change-password", function() {
    ...
    {
        User::setError("Digite a nove senha.");
        header("Location: /profile/change-password");
        exit;
    }
    ...
    {
        User::setError("As senhas digitadas não coincidem.");
        header("Location: /profile/change-password");
        exit;
    }
